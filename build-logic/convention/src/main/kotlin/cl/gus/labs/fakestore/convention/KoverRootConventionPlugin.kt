 ...
 * ignored without warning. The exclusion filters are shared with [excludeGeneratedAndWiring] instead:
 * a submodule's filters do not reach this merged report, but they do apply to that module's own
 * report, so both plugins declare the same list and both reports count the same classes.
 *
